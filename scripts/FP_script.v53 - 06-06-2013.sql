...
CREATE  TABLE IF NOT EXISTS `FirstPlace`.`Attendance` (
  ...
  PRIMARY KEY (`Student_s_id`, `Class_ID`, `Att_Date`) ,
...
CREATE  TABLE IF NOT EXISTS `FirstPlace`.`Notification` (
  ...
  INDEX `fk_Att_Ty_id_idx` (`Att_Ty_id` ASC) ,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `FirstPlace`.`notification_view` (`emp_id` INT, `emp_firstname` INT, `emp_lastname` INT, `not_id` INT, `not_Date` INT, `att_ty_id` INT, `st_id` INT, `st_firstname` INT, `st_lastname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `FirstPlace`.`ViewClassesForStudent`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `FirstPlace`.`ViewClassesForStudent` (`s_id` INT, `c_id` INT, `FirstName` INT, `LastName` INT, `ClassName` INT);
...
-- -----------------------------------------------------
-- View `FirstPlace`.`ViewAttendanceInfo`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `FirstPlace`.`ViewAttendanceInfo` ;
DROP TABLE IF EXISTS `FirstPlace`.`ViewAttendanceInfo`;
USE `FirstPlace`;
CREATE  OR REPLACE VIEW `FirstPlace`.`ViewAttendanceInfo` AS
...
CREATE  OR REPLACE VIEW `FirstPlace`.`notification_view` AS
 select 
    ...
    from
		...
		`Student` AS `s`
    where
        ((`no`.`Employee_emp_id` = `e`.`emp_id`) AND (`no`.`Student_s_id` = `s`.`s_id`))
	order by `no`.`Notf_Date` DESC;

-- -----------------------------------------------------
-- View `FirstPlace`.`ViewClassesForStudent`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `FirstPlace`.`ViewClassesForStudent` ;
DROP TABLE IF EXISTS `FirstPlace`.`ViewClassesForStudent`;
USE `FirstPlace`;
CREATE  OR REPLACE VIEW `FirstPlace`.`ViewClassesForStudent` AS
SELECT s_id, c_id, FirstName, LastName, ClassName FROM student 
JOIN student_has_class ON student_has_class.Student_s_id = student.s_id 
JOIN class ON class.c_id = student_has_class.Class_c_id
JOIN stdclass ON class.stdC_id = stdclass.stdC_id;
USE `FirstPlace`;
...
INSERT INTO `FirstPlace`.`Room` (`Room_ID`, `Location`) VALUES (NULL, 'ENGR-305');
INSERT INTO `FirstPlace`.`Room` (`Room_ID`, `Location`) VALUES (NULL, 'BANN-505');
...
START TRANSACTION;
USE `FirstPlace`;
INSERT INTO `FirstPlace`.`Employee` (`emp_id`, `Room_Room_ID`, `FirstName`, `LastName`, `PhoneNumber`, `Address`, `email_Address`, `password`, `username`, `Role_Role_ID`) VALUES (NULL, NULL, 'Tracy', 'Davies', 20601458, 'Broadway St.', 'tracy@test.com', '123', 'tracydav1', 1);
INSERT INTO `FirstPlace`.`Employee` (`emp_id`, `Room_Room_ID`, `FirstName`, `LastName`, `PhoneNumber`, `Address`, `email_Address`, `password`, `username`, `Role_Role_ID`) VALUES (NULL, 1, 'Padmini', 'Smith', 20611455, '2nd St.', 'padmini@test.com', '123', 'padsmith', 2);
INSERT INTO `FirstPlace`.`Employee` (`emp_id`, `Room_Room_ID`, `FirstName`, `LastName`, `PhoneNumber`, `Address`, `email_Address`, `password`, `username`, `Role_Role_ID`) VALUES (NULL, NULL, 'Ziyad', 'Joe', 20640112, 'Main St', 'ziyad@test.com', '123', 'ziyadJo', 3);
INSERT INTO `FirstPlace`.`Employee` (`emp_id`, `Room_Room_ID`, `FirstName`, `LastName`, `PhoneNumber`, `Address`, `email_Address`, `password`, `username`, `Role_Role_ID`) VALUES (NULL, 2, 'Michael', 'Smith', 70234042, '23rd St.', 'msmith@test.com', '111', 'msmith', 2);
INSERT INTO `FirstPlace`.`Employee` (`emp_id`, `Room_Room_ID`, `FirstName`, `LastName`, `PhoneNumber`, `Address`, `email_Address`, `password`, `username`, `Role_Role_ID`) VALUES (NULL, NULL, 'Ted', 'David', 20644458, '25th St.', 'tdavid@test.com', '14122', 'tdavid', 2);
...
START TRANSACTION;
USE `FirstPlace`;
INSERT INTO `FirstPlace`.`Student` (`s_id`, `FirstName`, `LastName`, `Grade`, `PhoneNumber`, `Address`, `email_address`, `YearStarted`, `Employee_emp_id`) VALUES (NULL, 'Mary ', 'Jane', '2nd', '20611145', 'Main St', 'mary@gmail.com', '2013-05-27', NULL);
INSERT INTO `FirstPlace`.`Student` (`s_id`, `FirstName`, `LastName`, `Grade`, `PhoneNumber`, `Address`, `email_address`, `YearStarted`, `Employee_emp_id`) VALUES (NULL, 'Joe', 'Smith', '3rd', '20645685', 'Tree St', 'joe@gmail.com', '2012-06-22', NULL);
INSERT INTO `FirstPlace`.`Student` (`s_id`, `FirstName`, `LastName`, `Grade`, `PhoneNumber`, `Address`, `email_address`, `YearStarted`, `Employee_emp_id`) VALUES (NULL, 'Kenny', 'Von', '4th', '30552524', '3rd NW PL', 'kenyy@gmail.com', '2013-05-29', NULL);
INSERT INTO `FirstPlace`.`Student` (`s_id`, `FirstName`, `LastName`, `Grade`, `PhoneNumber`, `Address`, `email_address`, `YearStarted`, `Employee_emp_id`) VALUES (NULL, 'Paul', 'Marten', '2nd', '20634045', '345 Ninth', 'paul@marten', '2012-04-05', NULL);
...
INSERT INTO `FirstPlace`.`Class` (`c_id`, `SchoolYear_sy_id`, `Room_Room_ID`, `stdC_id`, `Name`, `StartTime`, `EndTime`, `Employee_emp_id`) VALUES (NULL, 3, 2, 4, NULL, '12:00:00', '14:00:00', 2);
...
INSERT INTO `FirstPlace`.`Attendance_type` (`att_Ty_ID`, `att_Ty_Name`) VALUES (NULL, 'Excused Absence');
...
-- -----------------------------------------------------
-- Data for table `FirstPlace`.`Attendance`
-- -----------------------------------------------------
START TRANSACTION;
USE `FirstPlace`;
INSERT INTO `FirstPlace`.`Attendance` (`Student_s_id`, `Class_ID`, `att_Ty_ID`, `Att_Date`, `Comment`) VALUES (1, 2, 1, '2013-05-27', NULL);
INSERT INTO `FirstPlace`.`Attendance` (`Student_s_id`, `Class_ID`, `att_Ty_ID`, `Att_Date`, `Comment`) VALUES (1, 2, 1, '2013-05-28', NULL);
INSERT INTO `FirstPlace`.`Attendance` (`Student_s_id`, `Class_ID`, `att_Ty_ID`, `Att_Date`, `Comment`) VALUES (1, 2, 2, '2013-05-29', 'Good');
INSERT INTO `FirstPlace`.`Attendance` (`Student_s_id`, `Class_ID`, `att_Ty_ID`, `Att_Date`, `Comment`) VALUES (1, 2, 1, '2013-05-30', NULL);
INSERT INTO `FirstPlace`.`Attendance` (`Student_s_id`, `Class_ID`, `att_Ty_ID`, `Att_Date`, `Comment`) VALUES (1, 2, 1, '2013-05-31', NULL);
