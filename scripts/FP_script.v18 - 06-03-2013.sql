...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `FirstPlace`.`EmployeeListWithRoom` (`emp_id` INT, `FirstName` INT, `LastName` INT, `email_Address` INT, `username` INT, `password` INT, `Location` INT, `PhoneNumber` INT, `Address` INT);
...
select emp_id, FirstName, LastName, email_Address, username, password, Location, PhoneNumber, Address
