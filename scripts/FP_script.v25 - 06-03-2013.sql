...
-- -----------------------------------------------------
-- Placeholder table for view `FirstPlace`.`view1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `FirstPlace`.`view1` (`id` INT);

-- -----------------------------------------------------
-- Placeholder table for view `FirstPlace`.`viewgetTeachers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `FirstPlace`.`viewgetTeachers` (`firstname` INT, `lastname` INT, `email_address` INT, `username` INT, `password` INT, `room_room_id` INT);
...
-- -----------------------------------------------------
-- View `FirstPlace`.`view1`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `FirstPlace`.`view1` ;
DROP TABLE IF EXISTS `FirstPlace`.`view1`;
USE `FirstPlace`;
;
...
USE `FirstPlace`;
CREATE  OR REPLACE VIEW `FirstPlace`.`viewgetTeachers` AS
select e.firstname, e.lastname, e.email_address, e.username, 
e.password, e.room_room_id
from employee e, role r
where e.role_role_id = r.role_id
