...
START TRANSACTION;
USE `FirstPlace`;
INSERT INTO `FirstPlace`.`Employee` (`emp_id`, `Room_Room_ID`, `FirstName`, `LastName`, `PhoneNumber`, `Address`, `email_Address`, `password`, `username`, `Role_Role_ID`) VALUES (NULL, NULL, 'Tracy', 'Davies', 2060145858, 'Broadway St.', 'tracy@test.com', '123', 'tracydav1', 1);
INSERT INTO `FirstPlace`.`Employee` (`emp_id`, `Room_Room_ID`, `FirstName`, `LastName`, `PhoneNumber`, `Address`, `email_Address`, `password`, `username`, `Role_Role_ID`) VALUES (NULL, 1, 'Padmini', 'Smith', 2061145858, '2nd St.', 'padmini@test.com', '123', 'padsmith', 2);
INSERT INTO `FirstPlace`.`Employee` (`emp_id`, `Room_Room_ID`, `FirstName`, `LastName`, `PhoneNumber`, `Address`, `email_Address`, `password`, `username`, `Role_Role_ID`) VALUES (NULL, NULL, 'Ziyad', 'Joe', 2064011234, 'Main St', 'ziyad@test.com', '123', 'ziyadJo', 3);
INSERT INTO `FirstPlace`.`Employee` (`emp_id`, `Room_Room_ID`, `FirstName`, `LastName`, `PhoneNumber`, `Address`, `email_Address`, `password`, `username`, `Role_Role_ID`) VALUES (NULL, 2, 'Michael', 'Smith', 7023404243, '23rd St.', 'msmith@test.com', '111', 'msmith', 2);
INSERT INTO `FirstPlace`.`Employee` (`emp_id`, `Room_Room_ID`, `FirstName`, `LastName`, `PhoneNumber`, `Address`, `email_Address`, `password`, `username`, `Role_Role_ID`) VALUES (NULL, NULL, 'Ted', 'David', 2064445868, '25th St.', 'tdavid@test.com', '14122', 'tdavid', 2);
...
START TRANSACTION;
USE `FirstPlace`;
INSERT INTO `FirstPlace`.`Student` (`s_id`, `FirstName`, `LastName`, `Grade`, `PhoneNumber`, `Address`, `email_address`, `YearStarted`, `Employee_emp_id`) VALUES (NULL, 'Mary ', 'Jane', '2nd', '2061114545', 'Main St', 'mary@gmail.com', '2013-05-27', NULL);
INSERT INTO `FirstPlace`.`Student` (`s_id`, `FirstName`, `LastName`, `Grade`, `PhoneNumber`, `Address`, `email_address`, `YearStarted`, `Employee_emp_id`) VALUES (NULL, 'Joe', 'Smith', '3rd', '2064568585', 'Tree St', 'joe@gmail.com', '2012-06-22', NULL);
INSERT INTO `FirstPlace`.`Student` (`s_id`, `FirstName`, `LastName`, `Grade`, `PhoneNumber`, `Address`, `email_address`, `YearStarted`, `Employee_emp_id`) VALUES (NULL, 'Kenny', 'Von', '4th', '3055252488', '3rd NW PL', 'kenyy@gmail.com', '2013-05-29', NULL);
INSERT INTO `FirstPlace`.`Student` (`s_id`, `FirstName`, `LastName`, `Grade`, `PhoneNumber`, `Address`, `email_address`, `YearStarted`, `Employee_emp_id`) VALUES (NULL, 'Paul', 'Marten', '2nd', '2063404565', '345 Ninth', 'paul@marten', '2012-04-05', NULL);
