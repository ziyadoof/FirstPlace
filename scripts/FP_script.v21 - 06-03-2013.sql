...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `FirstPlace`.`EmployeeListWithRoomAndRole_View` (`emp_id` INT, `FirstName` INT, `LastName` INT, `email_Address` INT, `username` INT, `password` INT, `Location` INT, `PhoneNumber` INT, `Address` INT, `RoleName` INT);
...
SELECT emp_id, FirstName, LastName, email_Address, username, password, Location, PhoneNumber, Address, RoleName
FROM Employee 
